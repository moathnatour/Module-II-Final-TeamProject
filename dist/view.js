...
// }
// }
export function playGame(board, startButton) {
    const boardHeight = board.clientHeight;
    const boardWidth = board.clientWidth;
    const { addBall, movePaddles, checkForWallColision, checkForPaddleColision, leftPaddle, rightPaddle, balls, moveBalls } = startGame(boardHeight, boardWidth, 5);
